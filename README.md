...
├── trust.json # The trusted entity details for the  IAM role that the COdebuild will assume (to establish a relationship between the user and the service which will assume the role)
